...
**From the phone's browser:** open this file in the repository (GitHub shows a
*Download* button for it), then open the downloaded file from the notification or
from Files, and allow installation from that source when Android asks.
